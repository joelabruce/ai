...
impl Neural {
    ...
    pub fn get_next_batch(reader: &mut InputCsvReader, batch_size: usize) -> (Vec<Vec<f64>>, Matrix) {
...
mod tests {
    ...
    fn test() {
        ...
        let (validation_inputs, validation_tagets) = Neural::get_next_batch(&mut read_testing, v_batch_size);
        ...
        // Read from specified files for creating neural network
            ...
            let (mut normalized_inputs, mut targets) = Neural::get_next_batch(&mut read_training, batch_size);
            ...
            for batch in 0..batches {
                ...
                (normalized_inputs, targets) = Neural::get_next_batch(&mut read_training, batch_size);
