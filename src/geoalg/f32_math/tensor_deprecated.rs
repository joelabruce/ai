...
impl TensorDeprecated {
    ...
    /// TODO: 
    pub fn half_outer_cross_correlation(&self, _kernel: &TensorDeprecated) -> TensorDeprecated {
        TensorDeprecated {
            shape: vec![],
            values: vec![]
        }
    ...
    pub fn valid_cross_correlation(&self, kernel: &TensorDeprecated) -> TensorDeprecated {
